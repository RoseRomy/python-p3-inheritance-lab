...
class TestTeacher:
    ...
    def test_initializes_with_names(self):
        ...
        assert ((my_teacher.first_name, my_teacher.last_name)
                == ("My", "Teacher"))
    ...
    def test_has_attribute_knowledge(self):
        ...
        assert (isinstance(my_teacher.knowledge, list)
                and len(my_teacher.knowledge) > 0)

    def test_can_teach(self):
        '''teaches from list of knowledge.'''
        my_teacher = Teacher("My", "Teacher")
        assert my_teacher.teach().startswith("Teaching about")
        assert isinstance(my_teacher.teach(), str)
